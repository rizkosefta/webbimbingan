...
<section class="content-header">      
    <h1> Pengajuan Proposal Dosen Pembimbing</h1>
    <ol class="breadcrumb">
                ...
                <div class="col-md-8">
                    <form  method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <h3><label>Nama Distribusi Dosen Pembimbing</label></h3>
                            <ul class="timeline">
                            <li class="time-label">
                                  <span class="bg-red">
                                    *Dosen pembimbing sesuai dengan judul yang diterima
                                  </span>
                                </li>
                             </ul>
                                <label for="pembimbing1">Dosen Pembimbing</label>
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-primary" href="homepage.php?p=persetujuan_kpterima"><i class="fa fa-mail-reply"></i> Batal</a>
                            </div>
                        <div class="box box-info">
                        </div>
                    </form>
                    <?php
                        ...
                        if (isset($_POST[simpan])) {
                            {
                                $q = mysql_query("UPDATE pengajuan set nim='$x1',nama_lengkap='$x2',judul='$x4',jenis_laporan='$x3',status_dkn='$x5',pembimbing1='$x6' WHERE id_pengajuan='$id'");
                                    if($q){
                                    echo "<script language='javascript'>alert('Data Berhasil Diubah');document.location='homepage.php?p=persetujuan_kpterima';</script>";
                                    }
                                    else{
                                    echo "<script language='javascript'>alert('Data Gagal Diubah');document.location='homepage.php?p=persetujuan_kpterima';</script>"; 
                                    }
                            }
                        }
                    ?>                   
