...
<section class="content-header">      
    <h1> Distribusi Pembimbing Skripsi </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Distribusi Pembimbing Skripsi</li>
    </ol>
</section>
                ...
                <table id="myTable" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='homepage.php?p=dosbing_skripsi&dosbingskripsi=<?php echo $data[id_pengajuan] ?>' >
                                <button id='btn_create' class='btn btn-xs btn-primary' data-toggle='tooltip' data-container='body' title='Penentuan Pembimbing Skripsi'><span class='glyphicon glyphicon-random' aria-hidden='true'></span></button></a><br><br>
