<section class="content-header">      
    <h1> Jadwal Bimbingan Dosen </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Jadwal yang sudah disetujui</li>
    </ol>
</section>
    ...
    <div class="box box-info">            
        <div class="box-header">
            <div class="row-fluid" style="overflow:auto">
                ...
                <?php
                    $sql =  mysql_query("SELECT * FROM jadwal WHERE status='1' AND status1='1' ORDER BY id_jadwal DESC");
                    $no_urut = 1;
                ?>
