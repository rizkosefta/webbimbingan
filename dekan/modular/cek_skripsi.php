    ...
    <div class="box box-info">            
        <div class="box-header">
            <div class="row-fluid" style="overflow:auto">
                ...
                <?php
                    $sql =  "SELECT  * FROM pengajuan WHERE jenis_laporan='skripsi' AND status";
                ...
                <table id="myTable" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='homepage.php?p=plagiasi_skripsi&plagiasi=<?php echo $data[id_pengajuan] ?>' >
                                <button id='btn_create' class='btn btn-xs btn-primary' data-toggle='tooltip' data-container='body' title='Cek Plagiasi'><span class='glyphicon glyphicon-check' aria-hidden='true'></span></button></a><br><br>
