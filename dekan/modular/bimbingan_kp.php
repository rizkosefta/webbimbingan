    ...
    <div class="box box-info">
        <div class="box-header">
            <div class="row-fluid" style="overflow:auto">
                <div class="col-md-8">
                    <a href="homepage.php?p=add_bimbingan_skripsi" id='btn_add_new_data' class="btn btn-sm btn-success" title="Add Data">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href='homepage.php?p=edit_bimbingan_kpi&ubah=<?php echo $data['id_bimbingan'] ?>'>
                                    ...
                                    <a href='homepage.php?p=hapus_bimbingan_kp&hapus=<?php echo $data['id_bimbingan'] ?>'>
