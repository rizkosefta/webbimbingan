    ...
    <div class="box box-info">            
        <div class="box-header">
            <div class="row-fluid" style="overflow:auto">
                ...
                <li class="time-label">
                  <span class="bg-red">
                    *Jadwal yang telah disetujui Kaprodi akan tampil pada halaman ini
                  </span>
                    </li>
                </ul>
                ...
                <?php
                        ...
                        if (isset($_POST[simpan])) {
                                ...
                                $q = mysql_query("UPDATE jadwal SET status1='1' WHERE status1='0' ");
                                
                                if ($q){
                                    echo "<script language='javascript'>alert('Jadwal Berhasil Disetujui');document.location='homepage.php?p=jadwal_setujui1';</script>";
                                } 
                                else {
                                    echo "<script language='javascript'>alert('Jadwal Gagal Disetujui');document.location='homepage.php?p=setujui_jadwal';</script>";
                                }
                            }
                    ?>
                </form>
