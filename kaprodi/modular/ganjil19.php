<section class="content-header">      
    <h1> Data KP Semester Gasal 2019/2020 </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data KP Semester Gasal 2019/2020</li>
    </ol>
</section>
    ...
    <div class="box box-info">            
        <div class="box-header">
            ...
            <!-- Filter per semester -->                         
                ...
                <br>
                <a href="modular/export_ganjil19.php">                   
                    <button type="submit" class="btn btn-success" name="expor_ganjil19">export</button>
                </a>
                <br><br>
