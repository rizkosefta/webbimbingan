<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_distribusi_kp.xls");
	 
	
                        $sql =  "SELECT  * FROM pengajuan WHERE jenis_laporan='kp'AND status='1' order by id_pengajuan DESC ";
