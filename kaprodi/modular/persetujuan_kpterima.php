<section class="content-header">      
    <h1> Judul Kerja Praktek Yang Diterima </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Persetujuan Judul Kerja Praktek Yang Diterima</li>
    </ol>
</section>
    ...
    <div class="box box-info">            
        <div class="box-header">
            <div class="row-fluid" style="overflow:auto">
                ...
                <?php
                    $sql =  "SELECT  * FROM pengajuan WHERE jenis_laporan='kp'AND status='1' AND program_studi= 'Teknik Informatika - S1' order by id_pengajuan DESC ";
                ...
                <!-- Filter per semester -->
                <label for="ajara"> <h4>DATA SEMESTER..............................................................................................................</h4></label>
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <br>
                <a href="modular/export_judulkp.php">                   
                        ...
                        if (isset($_POST["btl"])) {
                            {
                                ...
                                if($q){
                                    echo "<script language='javascript'>document.location='homepage.php?p=persetujuan_kpterima';</script>";
                                    }
                                else{
                                    echo "<script language='javascript'>alert('Gagal Approve');document.location='homepage.php?p=persetujuan_kpterima';</script>"; 
                                    }
