<section class="content-header">      
    <h1> Data KP Semester Genap 2019/2020 </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data KP Semester Genap 2019/2020</li>
    </ol>
</section>
    ...
    <div class="box box-info">            
        <div class="box-header">
            ...
            <!-- Filter per semester -->                         
                ...
                <br>
                <a href="modular/export_genap19.php">                   
                    <button type="submit" class="btn btn-success" name="expor_genap19">export</button>
                </a>
                <br><br>
