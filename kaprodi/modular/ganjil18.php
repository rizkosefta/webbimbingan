<section class="content-header">      
    <h1> Data KP Semester Gasal 2018/2019 </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data KP Semester Gasal 2018/2019</li>
    </ol>
</section>
        ...
        <div class="box-header">
            ...
            <!-- Filter per semester -->                         
                ...
                <a href="modular/export_ganjil.php">                   
                    <button type="submit" class="btn btn-success" name="expor_ganjil18">export</button>
                </a>
                <br><br>
