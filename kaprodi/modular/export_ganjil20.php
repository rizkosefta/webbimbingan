<?php
    ...
    header("Content-Disposition: attachment; filename=distribusi_kp_gasal20.xls");
     
    
                $sql = "SELECT  * FROM pengajuan WHERE jenis_laporan='kp'AND semester='ganjil'AND status='1' order by id_pengajuan DESC ";
