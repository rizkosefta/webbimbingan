<section class="content-header">      
    <h1> Data  KP Semester Genap 2018/2019 </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data KP Semester Genap 2018/2019</li>
    </ol>
</section>
    ...
    <div class="box box-info">            
        <div class="box-header">
            ...
            <!-- Filter per semester -->
                ...
                <br>
                <a href="modular/export_genap.php">                   
                    <button type="submit" class="btn btn-success" name="expor_genap18">export</button>
                </a>
                <br><br>
                        ...
                        if (isset($_POST["expor"])) {
                            {
                                ...
                                if($q){
                                    echo "<script language='javascript'>alert('Berhasil Approve');document.location='homepage.php?p=genap18';</script>";
                                    }
                                else{
                                    echo "<script language='javascript'>alert('Gagal Approve');document.location='homepage.php?p=genap18';</script>"; 
                                    }
                            }
                        }
                        if (isset($_POST["btl"])) {
                            {
                                ...
                                if($q){
                                    echo "<script language='javascript'>document.location='homepage.php?p=genap18';</script>";
                                    }
                                else{
                                    echo "<script language='javascript'>alert('Gagal Approve');document.location='homepage.php?p=genap18';</script>"; 
                                    }
