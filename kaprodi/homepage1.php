          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p><h5><?php echo $_SESSION['nama_dkn'] ?></h5>
            ...
            <li class="header">Sistem Online Kerja Praktek dan Skripsi</li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>Distribusi Pembimbing</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="homepage.php?p=distribusi_dosbingkp"><i class="fa fa-circle-o"></i> Kerja Praktek</a></li>
                        <li><a href="homepage.php?p=distribusi_dosbingskripsi"><i class="fa fa-circle-o"></i> Skripsi</a></li>
                    </ul>          
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-check-square"></i>
                        <span>Persetujuan Jadwal Bimbingan</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="homepage.php?p=jadwal_kp"><i class="fa fa-circle-o"></i> Kerja Praktek</a></li>
                        <li><a href="homepage.php?p=jadwal_skripsi"><i class="fa fa-circle-o"></i> Skripsi</a></li>
                    </ul>          
                </li>
