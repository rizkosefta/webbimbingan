...
<head>
  ...
  <title>Universitas AKI .: Dasboard Kaprodi :.</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              ...
              <span>Pengecekkan dan Distribusi</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="homepage.php?p=kp"><i class="fa fa-circle-o"></i> Kerja Praktek</a></li>
              <li><a href="homepage.php?p=skripsi"><i class="fa fa-circle-o"></i> Skripsi</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="homepage.php?p=cek_jadwal"><i class="fa fa-circle-o"></i> Jadwal Baru<?php echo "$jb"; ?> </a></li>
              <li><a href="homepage.php?p=jadwal_disetujui"><i class="fa fa-circle-o"></i> Jadwal Disetujui<?php echo "$js"; ?></a></li>
            </ul>
          </li>
          <li><a href="homepage.php?p=pengumuman"><i class="fa fa-circle-o"></i> Pengumuman</a></li>
          <li><a href="homepage.php?p=pengumuman2"><i class="fa fa-circle-o"></i> Pengumuman2</a></li>
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
