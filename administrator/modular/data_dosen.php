    ...
    <div class="box box-info">            
        <div class="box-header">
            <div class="row-fluid" style="overflow:auto">
                <div class="col-md-8">
                <a href="homepage.php?p=add_dosen" id="btn_create" class='btn btn-success'><span class='glyphicon glyphicon-plus'></span> Tambah </a>
                </div> <br/><br/><br/>
                ...
                <table id="myTable" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='homepage.php?p=edit_dosen&ubah=<?php echo $data[nidn] ?>' >
                                ...
                                <a href='homepage.php?p=hapus_dosen&hapus=<?php echo $data[nidn] ?>' onclick='checkDelete()'>
