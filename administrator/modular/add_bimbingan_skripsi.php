...
<section class="content-header">      
    <h1> Tambah Data Bimbingan Skripsi </h1>
    <ol class="breadcrumb">
            ...
            <div class="row-fluid">
                <div class="col-md-8">
                    ...
                    <?php
                        ...
                        $q = mysql_query("INSERT INTO bimbinganskripsi (nim,nama_lengkap,program_studi,dosen_pembimbing,tgl_input,aktivitas,jenis_laporan,file,status,tgl_koreksi,uraian) 
