...
<?php 
    $ID =$_GET['ubah'];
    $sql = mysql_query("SELECT * FROM dekan WHERE nidn = '$ID'");
...
<section class="content-header">      
    <h1> Edit Dekan Fakultas </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Edit Dekan Fakultas</li>
    </ol>
</section>
                ...
                <div class="col-md-8">
                    ...
                    <?php
                        ...
                        else if($pass==$repass)
                        {
                            ...
                            $password=$passlama;
                            echo "<script language='javascript'>alert('password konfirmasi berbeda');document.location='homepage.php?p=data_dekan';</script>"; 
                        }
                        ...
                        if (isset($_POST[simpan])) {
                            ...
                            if(!empty($lokasi_file))
                            {
                                ...
                                $q = mysql_query("UPDATE dekan set nidn='$x1',nama_lengkap='$x2',jenis_kelamin='$x3',email='$x4',jabatan_fungsional='$x5',jabatan_struktural='$x6',foto='$nama_file',username='$x7',password='$password',level='d' WHERE nidn='$ID' ");
                                if($q)
                                    {
                                        echo "<script language='javascript'>alert('Data Berhasil Diubah');document.location='homepage.php?p=data_dekan';</script>";
                                    }
                                else
                                    {
                                        echo "<script language='javascript'>alert('Data Gagal Diubah');document.location='homepage.php?p=data_dekan';</script>"; 
                                    }
                            }
                            else
                            {
                                $q = mysql_query("UPDATE dekan set nidn='$x1',nama_lengkap='$x2',jenis_kelamin='$x3',email='$x4',jabatan_fungsional='$x5',jabatan_struktural='$x6',username='$x7',password='$password',level='d' WHERE nidn='$ID' ");
                                if($q)
                                    {
                                        echo "<script language='javascript'>alert('Data Berhasil Diubah');document.location='homepage.php?p=data_dekan';</script>";
                                    }
