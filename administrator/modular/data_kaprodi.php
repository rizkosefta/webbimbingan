    ...
    <div class="box box-info">            
        <div class="box-header">
            <div class="row-fluid" style="overflow:auto">
                <div class="col-md-8">
                <a href="homepage.php?p=add_kaprodi" id="btn_create" class='btn btn-success'><span class='glyphicon glyphicon-plus'></span> Tambah </a>
                </div> <br/><br/><br/>
                ...
                <table id="myTable" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='homepage.php?p=edit_kaprodi&ubah=<?php echo $data[nidn] ?>' >
                                ...
                                <a href='homepage.php?p=hapus_kaprodi&hapus=<?php echo $data[nidn] ?>' onclick='checkDelete()'>
