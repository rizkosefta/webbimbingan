...
<section class="content-header">      
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Tambah Dekan Fakultas</li>
    </ol>
</section>
                ...
                <div class="col-md-8">
                    ...
                    <?php
                        ...
                        if (isset($_POST[simpan])) {
                            ...
                            $cekSql = mysql_query("SELECT * from dekan where nidn = '$x1'");
                            if($ukuran_file > $size){
                                ...
                                {
                                    $q = mysql_query("INSERT INTO dekan (nidn,nama_lengkap,jenis_kelamin,email,jabatan_fungsional,jabatan_Struktural,foto,username,password,level)
                                    VALUES ('$x1','$x2','$x3','$x4','$x5','$x6','$nama_file','$x7','$pass','d')");
                                }
                            if($q)
                                {
                                    echo "<script language='javascript'>alert('Data Berhasil Ditambahkan');document.location='homepage.php?p=data_dekan';</script>";
                                }
                            else
                                {
                                    echo "<script language='javascript'>alert('Data Gagal Ditambahkan');document.location='homepage.php?p=add_dekan';</script>"; 
                                }
                        }
                    ?>
                </div>
