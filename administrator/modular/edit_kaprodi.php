...
<?php 
    $ID =$_GET['ubah'];
    $sql = mysql_query("SELECT * FROM kaprodi WHERE nidn = '$ID'");
...
<section class="content-header">      
    <h1> Edit Ketua Program Studi </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Edit Ketua Program Studi</li>
    </ol>
</section>
                    ...
                    <?php
                        ...
                        if (isset($_POST[simpan])) {
                            ...
                            if(!empty($lokasi_file))
                            {
                                ...
                                $q = mysql_query("UPDATE kaprodi set nidn='$x1',nama_lengkap='$x2',jenis_kelamin='$x3',email='$x4',jabatan_fungsional='$x5',jabatan_struktural='$x6',foto='$nama_file',username='$x8',password='$password',level='k' WHERE nidn='$ID' ");
                                if($q)
                                    {
                                        echo "<script language='javascript'>alert('Data Berhasil Diubah');document.location='homepage.php?p=data_kaprodi';</script>";
                                    }
                                else
                                    {
                                        echo "<script language='javascript'>alert('Data Gagal Diubah');document.location='homepage.php?p=data_kaprodi';</script>"; 
                                    }
                            }
                            else
                            {
                                $q = mysql_query("UPDATE kaprodi set nidn='$x1',nama_lengkap='$x2',jenis_kelamin='$x3',email='$x4',jabatan_fungsional='$x5',jabatan_struktural='$x6',username='$x8',password='$password',level='k' WHERE nidn='$ID' ");
                                if($q)
                                    {
                                        echo "<script language='javascript'>alert('Data Berhasil Diubah');document.location='homepage.php?p=data_kaprodi';</script>";
                                    }
