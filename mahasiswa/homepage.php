...
<head>
  ...
  <title>Universitas AKI .: Dasboard Mahasiswa :.</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              ...
              <span>Cek Duplikasi Judul</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="homepage.php?p=cek_kp"><i class="fa fa-circle-o"></i> Kerja Praktek</a></li>
              <li><a href="homepage.php?p=cek_skripsi"><i class="fa fa-circle-o"></i> Skripsi</a></li>
            </ul>
          </li>
          <li class="treeview">
