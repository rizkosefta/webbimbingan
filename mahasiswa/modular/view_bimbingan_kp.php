...
<section class="content-header">
    <h1> Lihat Bimbingan Kerja Praktek</h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Bimbingan Kerja Praktek</li>
        <li class="active">Lihat Bimbingan Kerja Praktek</li>
    </ol>
</section>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="semestermulaikp" rows="3" selected value="<?php echo $semestermulaikp; ?>" readonly></input>
                            </div>
                            <!-- form semester selesai kp -->
                            <div class="form-group">
                                <label>Semester Selesai KP</label>
                                <input class="form-control" name="semestermulaikp" rows="3" selected value="<?php echo $semesterselesaikp; ?>" readonly></input>
                            </div>
                            <!-- form aktivitas-->
                            <div class="form-group">
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-primary" href="homepage.php?p=bimbingan_kp"><i class="fa fa-mail-reply"></i> Kembali </a>
                            </div>
                        </div>
                    </form>
                </div>
