...
if (empty($_SESSION['username'])){
	...
	$content = "
				...
				<br><p align='center'><b>DISTRIBUSI DOSEN PEMBIMBING TUGAS AKHIR
				<br>SEMESTER GENAP 2018/2019</b></p>
			...
			$query = mysql_query("SELECT * FROM pengajuan");
